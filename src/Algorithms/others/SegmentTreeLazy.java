...
/**
 * @author Syed Ali.
 * @createdAt 22/12/2020, Tuesday, 23:36
...
public class SegmentTreeLazy {
	...
	static int getSum(int[] tree,int[] lazy,int start,int end,int qstart,
		...
		int mid = getMid(start, end);
		return getSum(tree,lazy,start,mid,qstart,qend,2*treeNode)+
				getSum(tree,lazy,mid+1,end,qstart,qend,2*treeNode+1);
	}
	...
	public static void main(String[] args) {
		...
		System.out.println(getSum(tree,lazy,0,arr.length-1,0,arr.length-1,1));
