...
public class SegmentTreeRangeMax {
    ...
    public SegmentTreeRangeMax(int size) {
        this.size = size;
    ...
    public static void main(String[] args) {
        ...
        SegmentTreeRangeMax segmentTreeRangeSum = new SegmentTreeRangeMax(10);
        segmentTreeRangeSum.build(arr);
        System.out.println(segmentTreeRangeSum.rangeMax(0, 9));
        System.out.println(segmentTreeRangeSum.rangeMax(0, 3));
        System.out.println(segmentTreeRangeSum.rangeMax(4, 9));
        System.out.println(segmentTreeRangeSum.rangeMax(3, 7));
